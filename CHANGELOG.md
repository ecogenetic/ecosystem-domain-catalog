...
## [Unreleased] — public collaboration refresh

### Added

- Public collaboration docs: `LICENSE` (Apache-2.0), `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`,
  `SECURITY.md`, `GOVERNANCE.md`, GitHub PR/issue templates
- Published design package under `meta-data/` for external product consumers
- Industry overlay for every domain that previously had none (≥1 industry per domain)
